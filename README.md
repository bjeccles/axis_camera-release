## axis_camera (indigo) - 0.3.0-0

The packages in the `axis_camera` repository were released into the `indigo` distro by running `/usr/bin/bloom-release axis_camera --track indigo --rosdistro indigo --override-release-repository-url https://github.com/bjeccles/axis_camera-release.git` on `Tue, 17 Jul 2018 20:31:31 -0000`
